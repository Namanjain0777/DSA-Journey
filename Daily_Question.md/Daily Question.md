...
```
📌 Focus: loops, conditions, variables
...
```
📌 Focus: nested loops, dry run skill
...
```
📌 Focus: using library efficiently
## Lec 4: Basic Maths
(Number theory – very important)
```
...
```
📌 Focus: base case + recursive call
...
```
📌 Focus: monotonic condition (true → true)
...
```
📌 Focus: indexing, loops, char handling
...
```
📌 Focus: precision, overflow handling
...
```
📌 Focus: slow-fast pointer, edge cases


# STEP 7: RECURSION
## Lec 1 : Recursion – Level 1 (Basics)
```
1. Print numbers from 1 to N using recursion
2. Print numbers from N to 1 using recursion
3. Find factorial of a number
...
```
## Lec 2 : Recursion – Array Questions
```
...
```
## Lec 3 : Recursion – Pattern Questions
```
...
```
## Lec 4 : Recursion – Subset / Subsequence / String
```
...
## Lec 6 : Backtracking – Maze Problems
```
...
```
📌 Focus: FIFO, front/rear handling
## Lec 3 : Stack & Queue
```
...
```
📌 Focus: simulation, auxiliary data structures
...
5. Find the minimum size subarray with sum ≥ target
```
...
```
📌 Focus: parent–child index formula
...
```
📌 Focus: min-heap vs max-heap choice
## Lec 3 : Heapsort
```
...
```
📌 Focus: in-place sorting, O(n log n)
...
```
📌 Focus: sorting + local optimal choice
...
```
📌 Focus: sorting by end time / start time
...
```
📌 Focus: using BST ordering to optimize
...
```
📌 Focus: inorder traversal counting
...
```
📌 Focus: inorder violation, prev pointer
...
```
📌 Focus: data structures, indexing
...
```
📌 Focus: visited array, traversal order

##  Lec 3 : Shortest Path (Unweighted Graphs – BFS)
```
...
5. Word Ladder – find length of shortest transformation sequence
```
📌 Focus: BFS + queue + level tracking

##  Lec 4 : Topological Sort & DAG 
```
1. Perform topological sort using DFS
2. Perform topological sort using BFS (Kahn’s Algorithm)
3. Detect a cycle in a directed graph
4. Check if a graph is a DAG
5. Find shortest path in a DAG
```
📌 Focus: indegree, ordering
...
```
📌 Focus: BFS/DFS pattern recognition
...
```
📌 Focus: recurrence → dp array

## Lec 2 : DP on Arrays 
```
1. Find maximum subarray sum (Kadane’s DP view)
...
```
📌 Focus: return multiple values from recursion
...
```
📌 Focus: node structure, children map
...
```
📌 Focus: DFS on Trie nodes

# STEP 18: STRINGS (HARD)
## Lec 1 : String Matching (Karp–Rabin) 
```
1. Implement Rabin–Karp algorithm for string matching
...
5. Detect false positives in Rabin–Karp matching
```
...
```
📌 Focus: hashing + window + optimization
...
```
📌 Focus: mutability, thread safety